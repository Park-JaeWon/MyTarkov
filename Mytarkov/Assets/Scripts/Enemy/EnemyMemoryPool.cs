...
public class EnemyMemoryPool : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject enemySpawnPointPrefab;//등장 위치를 알려주는 프리팹
    [SerializeField]
    private GameObject enemyPrefab;//생성되는 적 프리팹
    [SerializeField]
    private float enemySpawnTime = 1;//적 생성 주기
    [SerializeField]
    private float enemySpawnLatency = 1;//적 등장하기까지 대기 시간

    private MemoryPool spawnPointMemoryPool;//적 등장 위치 오브젝트 생성, 활성/비활성 관리
